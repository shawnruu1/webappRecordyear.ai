...
function buildPrompt(): string {
  return `You are a career record assistant for sales professionals. Analyze this document and extract every distinct professional win, achievement, or milestone you can find.
...
- happened_at: ISO date string if a date is visible in the document, otherwise null
- raw_excerpt: a short quote or description of where this win appears, including the original MRR figure
